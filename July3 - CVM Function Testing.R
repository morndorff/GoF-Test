...
# Developing suitable functions and exploring ways
# of computing the Cramer von Mises test for one and two samples

# Results: For one sample tests, use of:
# cvm.test(x, "pnorm", mean="2", sd="1") is recommended
# library(goftest)

# For two sample tests, use of:
# CramerVonMisesTwoSamples(x,y) is recommended
# library(CDFt)
