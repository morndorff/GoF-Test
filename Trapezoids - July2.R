#July 2, 2014
#Goals: Design 'Trapezoid' Area approximation for two pdfs

# Start: Consider two pdfs
# X ~ N(0,sqrt(3))
# Y ~ t(3)
...
# Height of trapezoid is 2*delta
# Length of top side is abs(x1_p_del - y1_p_del)
