...
make_sample <- function(n, dist, params) {
    # Args: dist: 'norm', 'unif', etc.  n: sample size params: list(min=0,max=2) Ex: sam
    # <- make_sample(n=100,dist=unif,params=list(min=0,max=2)) sam <-
    # make_sample(n=1000,dist=norm,params=list(mean=0,sd=2))
